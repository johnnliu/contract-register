...
var kwin = angular.module('kendo.window', []);

kwin.factory('$$stackedMap', function () {
    return {
        createNew: function () {
            var stack = [];
            return {
...
kwin.directive('kWindowTransclude', function () {
    return {
...
kwin.provider('$kWindow', function () {
    var $modalProvider = {
        options: {
            animation: false,
            keyboard: true
